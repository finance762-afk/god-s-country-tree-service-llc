  ...
  <nav class="navbar" aria-label="Main navigation">
    <div class="navbar-inner container">
      ...
      <a href="/" class="navbar-logo" aria-label="<?php echo e($siteName); ?> — Home">
        <img src="/assets/images/Gods-Country-Newest-Logo.webp" class="navbar-logo-img" width="800" height="450" alt="<?php echo e($siteName); ?> — tree service in Central-East Florida">
      </a>
